...
export const Resources: React.FC = () => {
  ...
  const cardStyle = { background: "#343a40" }
  const cardTitleStyle = { color: "#00c895" }
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="space-y-4">
        <a
          ...
          style={cardStyle}
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">API Tutorials</div>
        ...
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">GitHub Samples</div>
        ...
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">Codelabs & Workshops</div>
      ...
      <div className="space-y-4">
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">Training & Certifications</div>
        ...
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">SDKPerf</div>
        ...
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">Connector Hub</div>
      ...
      <div className="space-y-4">
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">Developer Community</div>
        ...
        <a
          ...
          className="block text-white p-6 rounded-lg shadow transition"
        >
          <div style={cardTitleStyle} className="text-xl mb-2">Engage with an Advocate</div>
